...
'''
twomass.py - Waqas Bhatti (wbhatti@astro.princeton.edu) - Sept 2013

Contains various useful tools for 2MASS catalog processing.
...
# setup a logger
LOGGER = logging.getLogger('twomass')
...
# see hatpipe/source/2mass/jhktrans.c
